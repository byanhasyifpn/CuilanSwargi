    ...
    <div class="success-card">
        ...
        <div class="success-header">
            <div class="relative z-10">
                ...
                <p class="text-white/65 text-sm">
                    Your reservation data has been saved
                </p>
            </div>
        </div>
        ...
        <div class="p-6 sm:p-8">
            ...
            <div class="order-code-box">
                <p class="text-xs text-gray-400 uppercase tracking-widest mb-1.5 font-semibold">Order Code</p>
                <p class="font-mono text-2xl sm:text-3xl font-extrabold text-primary tracking-[0.15em]">
                    {{ $booking->order_code }}
                </p>
                <p class="text-xs text-gray-400 mt-1.5">Save this code as proof of reservation</p>
            </div>
            ...
            <div class="detail-grid">
                ...
                <div class="detail-row">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-xs text-gray-400 mb-0.5">Check-in Date</p>
                ...
                <div class="detail-row">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-xs text-gray-400 mb-0.5">Check-out Date</p>
