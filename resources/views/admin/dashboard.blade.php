...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-5 sm:p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-500 text-xs sm:text-sm mb-1">Total Galeri</p>
                <h3 class="text-2xl sm:text-3xl font-bold text-primary">{{ $galleryCount }}</h3>
            </div>
        ...
        <a href="{{ route('admin.gallery.index') }}" class="block mt-4 text-primary hover:text-primary/80 font-semibold text-sm sm:text-base">
            Kelola Galeri &rarr;
        </a>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-5 sm:p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-500 text-xs sm:text-sm mb-1">Total Penginapan</p>
                <h3 class="text-2xl sm:text-3xl font-bold text-primary">{{ $accommodationCount }}</h3>
            </div>
            <div class="bg-primary/10 p-3 sm:p-4 rounded-full flex-shrink-0">
                <svg class="w-8 h-8 sm:w-10 sm:h-10 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('admin.accommodation.index') }}" class="block mt-4 text-primary hover:text-primary/80 font-semibold text-sm sm:text-base">
    ...
    <div class="bg-white rounded-lg shadow-md p-5 sm:p-6 sm:col-span-2 lg:col-span-1">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl sm:text-3xl font-bold text-primary">{{ $articleCount }}</h3>
                <p class="text-xs sm:text-sm text-gray-500 mt-1">{{ $publishedArticleCount }} Dipublikasikan</p>
            </div>
            <div class="bg-primary/10 p-3 sm:p-4 rounded-full flex-shrink-0">
                <svg class="w-8 h-8 sm:w-10 sm:h-10 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="bg-white rounded-lg shadow-md p-5 sm:p-8">
    <h2 class="text-xl sm:text-2xl font-bold text-primary mb-3 sm:mb-4">Selamat Datang di Admin Panel!</h2>
    ...
    <div class="bg-secondary/30 p-3 sm:p-4 rounded-lg">
